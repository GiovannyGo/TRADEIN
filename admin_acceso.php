...
<div class="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 transform transition-all duration-300 hover:shadow-xl">
    <!-- Logo -->
    ...
    <div class="mb-4 p-3 bg-red-50 border border-red-200 text-red-700 rounded-xl text-sm text-center flex items-center justify-center gap-2">
    ...
    <form action="admin_login.php" method="POST">
        <div class="mb-4">
            ...
            <div class="relative">
                ...
                <input type="text" name="user" required 
                       class="w-full pl-10 pr-3 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#F97316] focus:border-transparent transition"
                       placeholder="admin">
            </div>
        </div>
        ...
        <button type="submit" class="w-full bg-gradient-to-r from-[#F97316] to-[#EA580C] text-white py-3 rounded-xl font-semibold hover:from-[#EA580C] hover:to-[#F97316] transition-all duration-300 shadow-md hover:shadow-lg flex items-center justify-center gap-2">
